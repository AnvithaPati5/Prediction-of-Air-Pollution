...
FIELD BASED PROJECT REPORT (2022-2026 Batch) Dept. of CSE(AIML) 20
import datetime
import openpyxl
...
ClientRegister_Model,air_quality_type,air_quality_type_ratio
def login(request):
...
FIELD BASED PROJECT REPORT (2022-2026 Batch) Dept. of CSE(AIML) 21
...
FIELD BASED PROJECT REPORT (2022-2026 Batch) Dept. of CSE(AIML) 22
...
FIELD BASED PROJECT REPORT (2022-2026 Batch) Dept. of CSE(AIML) 23
...
FIELD BASED PROJECT REPORT (2022-2026 Batch) Dept. of CSE(AIML) 24
elif (prediction == 3):
val= 'Moderate'
elif (prediction == 4):
val= 'Satisfactory'
